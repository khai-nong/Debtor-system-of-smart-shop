...
<p>&nbsp;</p>
    ...
    <br>
    <form action="add_paydebt-auto.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
        <table align="center" width="600" height="310" >
            ...
            <tr>
              <td colspan="3" align="center"><a href="add_paydebt-auto.php?did=<?php echo $row_Rec_debtor['debtorID']; ?>"><input type="submit" value="เพิ่มข้อมูล" class="enter"></a>&nbsp;&nbsp;
              <a href="edit_menu_debtor.php"><input value=" กลับไป " class="button-9"></a></td>
            </tr>
        </table>
