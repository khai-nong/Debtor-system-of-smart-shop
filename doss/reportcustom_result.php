...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  //กำหนดวันเริ่มต้น
  $start = $_POST['textdaystart'];
  //กำหนดวันสิ้นสุด
  $end = $_POST['textdayend'];
}
...
<title>ผลการออกรายงาน : ยอดหนี้-ยอดชำระแบบกำหนดเอง</title>
...
if ($totalRows_Rec_report == 0) {
  ...
  echo 'window.location.href = "reportcustom.php";</script>';
}
?>
<p></p>
<center>
...
<p></p>
    <h2>ร้าน Smart Shop<br>รายงานสรุปยอดหนี้ - ยอดชำระ ตั้งแต่ <?php echo $start_formatted; ?> จนถึง <?php echo $end_formatted; ?></h2>
    <table class="table_detail3">
      <tr class="tr_head2">
        <td width="300">วันที่มาค้างชำระ</td>
        <td width="100">รหัสลูกหนี้</td>
        <td width="250">ชื่อ - นามสกุล</td>
        <td width="150">ยอดหนี้:บาท</td>
        <td width="150">ยอดชำระ:บาท</td>
              </tr>
              <?php do { ?>
                <tr class="tr_center">
                  <td>
