...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO receipt(debtorID, perroundID, receiptPay, receiptOwe, receiptLeft, mustpay) VALUES (%s, %s, %s, %s, %s, %s)",
    GetSQLValueString($debtorID, "double"),
...
<form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return validate();">
  <table align="center">
    <tr>
      <td class="head2" align="left" width="200" height="50">รหัสลูกหนี้</td>
      <td style="color: #1D92FC; text-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);"><?php echo $row_Rec_debtor['debtorID'] .' - '.$row_Rec_debtor['FirstName'] . ' ' . $row_Rec_debtor['LastName']; ?></td>
    </tr>
    <tr>
      <td class="head2" align="left" height="60">รอบการชำระ</td>
      <td class="select">
  ...
  <tr>
    ...
    <td colspan="2" align="center"><input type="submit" value="เพิ่มข้อมูล" class="enter">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <a href="edit_menu_alldebtor.php"><input value=" กลับไป " class="button-9"></a></td>
    </tr>
  </table>
