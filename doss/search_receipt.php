...
<h1>ค้นหาการค้างชำระ</h1>
<table>
  <tr>
    <td align="center">
    <form id="form1" name="form1" method="post" action="search_receipt_result.php">
  <p>
  ...
  <p>&nbsp;</p>
  <input type="submit" name="button" id="button" value="ตกลง" class="button-9-2"/>
  </form>
