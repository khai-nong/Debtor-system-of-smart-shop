...
<p>&nbsp;</p>
<p>&nbsp;</p>
    <center><h1 class="topic">ลูกหนี้</h1>
    <table>
<tr>
    <td align="center"><a href="add_debtor.php">
    <img src="img/add.png" class="pic">
    </a></td>
    <td width="140">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td><a href="search_debtor_menu.php">
    <img src="img/search.png" class="pic">
    </a></td>
</tr>
<tr>
    <td id="name">เพิ่มข้อมูลลูกหนี้</td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td id="name">ค้นหาข้อมูลลูกหนี้</td>
</tr>
</table>
</center>
</button>
