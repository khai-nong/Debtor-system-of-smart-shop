...
<title>ค้นหาข้อมูลลูกหนี้ทั้งหมด</title>
...
<p>&nbsp;</p>
<center>
<img src="img/search_debtor.png"></td>
<h1>ค้นหาข้อมูลลูกหนี้ทั้งหมด</h1>
</tr>
<table>
  <tr>
    <td align="center">
    <form id="form1" name="form1" method="post" action="edit_menu_alldebtor.php">
  <p>
...
<p>&nbsp;</p>
<form id="form2" name="form2" method="post" action="search_debtor.php">
  <p>
    <input type="submit" name="button2" id="button2" value="ข้อมูลลูกหนี้ปัจจุบัน" class="button-9-2"/>
  </p>
</form>
</table>
</center>
