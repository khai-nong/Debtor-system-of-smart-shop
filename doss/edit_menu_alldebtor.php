...
$query_Rec_debtor = sprintf("SELECT debtorID, FirstName, LastName, Addr, tell FROM debtor WHERE (FirstName LIKE %s) OR (LastName LIKE %s) ORDER BY FirstName ASC", GetSQLValueString("%" . $colname_Rec_debtor . "%", "text"),GetSQLValueString("%" . $colname_Rec_debtor . "%", "text"));
...
if ($row_Rec_debtor == 0) {
  echo '<script>window.location.href = "search_alldebtor.php";';
  echo 'alert("ไม่พบข้อมูลลูกหนี้ที่ต้องการ \nกรุณาเพิ่มข้อมูลหรือตรวจสอบชื่อ-นามสกุลอีกครั้ง");</script>';
}
...
<title>ผลการค้นหา : ลูกหนี้ทั้งหมด</title>
...
<p>&nbsp;</p>
<center>
<h1>ผลการค้นหาลูกหนี้ทั้งหมด</h1>
...
<table class="table_detail">
        <tr class="tr_head">
          ...
          <td width="300" align="center">ที่อยู่</td>
          <td width="150" align="center">เบอร์โทร</td>
          <td width="50" align="center">แก้ไข</td>
          <td width="50" align="center">ลบ</td>
          <td width="80" align="center">เพิ่มการ&nbsp;<br>ค้างชำระ&nbsp;</td>
        </tr>
        <?php do { ?>
          <tr class="tr_center">
            ...
            <td><?php echo $row_Rec_debtor['Addr']; ?></td>
            <td><?php echo $row_Rec_debtor['tell']; ?></td>
            <td align="center"><a href="edit_debtor.php?did=<?php echo $row_Rec_debtor['debtorID']; ?>"><img src="img/pen.png"></a></td>
            <td align="center"><a onclick="return confirm('ต้องการลบ <?php echo $row_Rec_debtor['debtorID'] .' - '. $row_Rec_debtor['FirstName']; ?> ใช่หรือไม่')" href="delete_debtor.php?did=<?php echo $row_Rec_debtor['debtorID']; ?>"><img src="img/bin.png"></a></td>
            <td align="center"><a href="add_receipt-auto.php?did=<?php echo $row_Rec_debtor['debtorID']; ?>"><img src="img/add_icon.png"></a></td>
          </tr>
