...
function validate(){
  if(document.form2.txtmonth.value=="คลิกเพื่อเลือกเดือน"){
      alert("กรุณาเลือกเดือนที่ต้องการ");
      document.form2.txtmonth.focus();
      return false;
  }
...
<link href="css/report_design.css" rel="stylesheet" type="text/css"/>
</head>
...
<h1>ออกรายงานประจำเดือน</h1>
<span class="head">เลือกเดือนและกรอกปีที่ต้องการออกรายงาน</span>
<p>&nbsp;</p>
<form id="form2" name="form2" method="post" action="reportmonth_result.php" onsubmit="return validate();">
      <div class="select">
          <select name="txtmonth" id="txtmonth">
            <option selected disabled>คลิกเพื่อเลือกเดือน</option>
        ...
        <span class="head">&nbsp;&nbsp;&nbsp;&nbsp;ปี ค.ศ.&nbsp;&nbsp;&nbsp;<input name="txtyear" type="number" id="txtyear" value="<?php echo date("Y"); ?>"/>
      </span>
  <p>&nbsp;</p>
  <input type="submit" name="button" id="button" value="ตกลง" class="button-9"/>
</table>
</form>
</center>
</body>
