...
<html>
<head>
<title>Doss : เมนู-ออกรายงาน</title>
...
<p>&nbsp;</p>
<p>&nbsp;</p>
    <center><h1 class="topic">ออกรายงาน</h1>
    <table>
    <tr>
    <td align="center"><a href="reportmonth.php">
    <img src="img/month.png" class="pic">
    </a></td>
    <td width="50">&nbsp;</td>

    <td align="center"><a href="reportyear.php">
    <img src="img/year.png" class="pic">
    </a></td>
    <td width="50">&nbsp;</td>
    
    <td align="center"><a href="reportcustom.php">
    <img src="img/custom.png" class="pic">
    </a></td>
    <td width="50">&nbsp;</td>
    </a></td>
</tr>
<tr>
<td id="name">ออกรายงาน<br>ประจำเดือน</td>
    <td width="50">&nbsp;</td>
    <td id="name">ออกรายงานประจำปี</td>
    <td width="50">&nbsp;</td>
    <td id="name">ออกรายงาน<br>แบบกำหนดเอง</td>
    <td width="50">&nbsp;</td>
</tr>
</table>
</center>
