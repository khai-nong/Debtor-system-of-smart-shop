...
<title>ค้นหาข้อมูลลูกหนี้ปัจจุบัน</title>
...
<p>&nbsp;</p>
<center>
<img src="img/search-profile.png"></td>
<h1>ค้นหาข้อมูลลูกหนี้ปัจจุบัน</h1>
<table>
  <tr>
    <td align="center">
    <form id="form1" name="form1" method="post" action="edit_menu_debtor.php">
  <p>
    <label for="textsearch"></label>
    <input name="textsearch" type="text" id="textsearch" size="60" placeholder="กรุณากรอกชื่อ หรือ นามสกุล" />
    <input type="submit" name="button" id="button" value="" class="button-9"/>
  </p>
  </form>

  <p>&nbsp;</p>
  <form id="form2" name="form2" method="post" action="search_alldebtor.php">
  <p>
    <input type="submit" name="button2" id="button2" value="ข้อมูลลูกหนี้ทั้งหมด" class="button-9-2"/></p>
</form>
</table>
</body>
</html>