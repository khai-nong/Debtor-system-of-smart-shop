...
<html>
<head>
  <title>Doss : เมนู-ค้นหาข้อมูลลูกหนี้</title>
...
<p>&nbsp;</p>
<p>&nbsp;</p>
    <center><h1 class="topic">ค้นหาข้อมูลลูกหนี้</h1>
    <table>
<tr>
    <td align="center"><a href="search_debtor.php">
    <img src="img/search-profile.png" class="pic">
    </a></td>
    <td width="140">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td><a href="search_alldebtor.php">
    <img src="img/search_debtor.png" class="pic">
    </a></td>
</tr>
<tr>
    <td id="name">ค้นหาข้อมูลลูกหนี้ปัจจุบัน</td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td id="name">ค้นหาข้อมูลลูกหนี้ทั้งหมด</td>
</tr>
</table>
</center>
</button>
